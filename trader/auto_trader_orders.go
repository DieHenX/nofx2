...
func (at *AutoTrader) executeOpenLongWithRecord(decision *kernel.Decision, actionRecord *store.DecisionAction) error {
	...
	// Send notification
	if at.notifier != nil {
		go at.notifier.SendOpenPositionNotification(at.name, at.exchange, decision.Symbol, "long", quantity, marketData.CurrentPrice, decision.Leverage, decision.Confidence)
	}
...
func (at *AutoTrader) executeOpenShortWithRecord(decision *kernel.Decision, actionRecord *store.DecisionAction) error {
	...
	// Send notification
	if at.notifier != nil {
		go at.notifier.SendOpenPositionNotification(at.name, at.exchange, decision.Symbol, "short", quantity, marketData.CurrentPrice, decision.Leverage, decision.Confidence)
	}
...
func (at *AutoTrader) executeCloseLongWithRecord(decision *kernel.Decision, actionRecord *store.DecisionAction) error {
	...
	if at.notifier != nil {
		...
		go at.notifier.SendClosePositionNotification(at.name, at.exchange, decision.Symbol, "long", quantity, entryPrice, marketData.CurrentPrice, pnl)
	}
...
func (at *AutoTrader) executeCloseShortWithRecord(decision *kernel.Decision, actionRecord *store.DecisionAction) error {
	...
	if at.notifier != nil {
		...
		go at.notifier.SendClosePositionNotification(at.name, at.exchange, decision.Symbol, "short", quantity, entryPrice, marketData.CurrentPrice, pnl)
	}
